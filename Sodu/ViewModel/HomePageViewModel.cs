...
namespace Sodu.ViewModel
{
    public class HomePageViewModel : BaseViewModel, IViewModel
    {
        ...
        private ObservableCollection<BookEntity> m_UpdateBookList = new ObservableCollection<BookEntity>();
        public ObservableCollection<BookEntity> UpdateBookList
        {
            get
            {
                return m_UpdateBookList;
            }
            set
            {
                this.SetProperty(ref this.m_UpdateBookList, value);
            }
        }
        ...
        public async void RefreshData(object obj = null, bool IsRefresh = true)
        {
            ...
            try
            {
                ...
                if (IsLoading || !IsRefresh || (obj == null && this.UpdateBookList.Count > 0))
                {
                    return;
                }
                ...
                html = await http.HttpClientGetRequest(string.Format(PageUrl.HomePage, PageIndex));
